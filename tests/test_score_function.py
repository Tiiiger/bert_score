...
class TestScore(unittest.TestCase, CustomAssertions):
    ...
    def test_idf_score_rescale_fast_tokenizer(self):
        ...
        self.assertAreTensors(P, R, F)
        self.assertTensorsAlmostEqual(P, [0.9060347080230713, 0.8529528975486755, 0.4002779722213745])
        self.assertTensorsAlmostEqual(R, [0.907024621963501, 0.8212453722953796, 0.514383852481842])
        self.assertTensorsAlmostEqual(F, [0.9066815376281738, 0.8373198509216309, 0.45761245489120483])
