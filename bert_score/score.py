...
# Under Construction
def plot_example(h, r, model_type=None, lang=None, num_layers=None, fname=''):
    """
    BERTScore metric.
    ...
    ref_embedding, ref_masks, padded_idf = get_bert_embedding([r], model, tokenizer, idf_dict,
                                       device=device)
    hyp_embedding, ref_masks, padded_idf = get_bert_embedding([h], model, tokenizer, idf_dict,
                                       device=device)
    ...
    plt.xlabel("Reference", fontsize=10)
