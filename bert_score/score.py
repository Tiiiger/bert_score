...
# Under Construction
def plot_example(candidate, reference, model_type='bert-base-uncased', num_layers=None, fname='', lang=None):
    ...
    h_tokens = ['[CLS]'] + tokenizer.tokenize(candidate[0]) + ['[SEP]']
    r_tokens = ['[CLS]'] + tokenizer.tokenize(reference[0]) + ['[SEP]']
